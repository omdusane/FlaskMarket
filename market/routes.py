...
from market.forms import RegisterForm, LoginForm, PurchaseItemForm, SellItemForm, IncreaseBudgetForm
...
def market_page():
    ...
    increase_budget_form = IncreaseBudgetForm()
    #formvalidateonsubmit then add form then modify database then render redirect ig not sure and for superuser Add Flask_Admin 
